...
def init_option_parser():
    ...
    parser.add_option("-i", "--input_features_dir", action="store", type="string", default="",
                      help="path to the video features")
    parser.add_option("-n", "--rate", action="store", type=int, default=10,
                      help="Get a frame every from every n frames")
