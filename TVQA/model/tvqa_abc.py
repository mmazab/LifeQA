...
class ABC(nn.Module):
    ...
    def forward(self, q, q_l, a0, a0_l, a1, a1_l, a2, a2_l, a3, a3_l, sub, sub_l, vcpt, vcpt_l, vid, vid_l):
        ...
        if self.sub_flag:
            ...
            sub_out = self.stream_processor(self.lstm_mature_sub, self.classifier_sub, raw_out_sub, sub_l,
                                            ...
                                            raw_out_a2, a2_l, raw_out_a3, a3_l)
        else:
            sub_out = 0
    ...
    def stream_processor(self, lstm_mature, classifier, ctx_embed, ctx_l,
                         q_embed, q_l, a0_embed, a0_l, a1_embed, a1_l, a2_embed, a2_l, a3_embed, a3_l):
        ...
        mature_answers = torch.cat([
            mature_maxout_a0, mature_maxout_a1, mature_maxout_a2, mature_maxout_a3
        ], dim=1)
    ...
    def get_fake_inputs(device="cuda:0"):
        ...
        return q, q_l, a0, a0_l, a1, a1_l, a2, a2_l, a3, a3_l, sub, sub_l, vcpt, vcpt_l, vid, vid_l
